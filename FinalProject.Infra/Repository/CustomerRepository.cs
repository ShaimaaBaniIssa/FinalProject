...
namespace FinalProject.Infra.Repository
{
    public class CustomerRepository : ICustomerRepository
    {
...

        {
            ...
            p.Add("p_adress", customer.Address, dbType: DbType.String, direction: ParameterDirection.Input);
        ...
        public void UpdateLatLong(int id, decimal Latitude, decimal Longitude)
        {
            var p = new DynamicParameters();
            p.Add("p_CustomerId", id, dbType: DbType.Int32, direction: ParameterDirection.Input);
            p.Add("p_Latitude", Latitude, dbType: DbType.Decimal, direction: ParameterDirection.Input);
            p.Add("p_Longitude", Longitude, dbType: DbType.Decimal, direction: ParameterDirection.Input);
            _dbContext.Connection.Execute("Customer_Package.UpdateLatLong", p, commandType: CommandType.StoredProcedure);
        }
